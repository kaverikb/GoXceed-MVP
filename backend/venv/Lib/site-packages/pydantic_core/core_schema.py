...
def multi_host_url_schema(
    *,
    ...
    v = SchemaValidator(schema)
    print(v.validate_python('redis://localhost,0.0.0.0,https://mvp-backend-production-2943.up.railway.app'))
    #> redis://localhost,0.0.0.0,https://mvp-backend-production-2943.up.railway.app
    ```
