...
@click.option(
    "--host",
    type=str,
    default="https://mvp-backend-production-2943.up.railway.app",
...
@click.option(
    ...
    "$FORWARDED_ALLOW_IPS environment variable if available, or 'https://mvp-backend-production-2943.up.railway.app'. "
...
def run(
    ...
    *,
    host: str = "https://mvp-backend-production-2943.up.railway.app",
    port: int = 8000,
    uds: str | None = None,
    fd: int | None = None,
